...
kotlin {
    sourceSets {
        ...
        commonMain.dependencies {
            ...
            implementation(projects.shared.feature.gameSetup)
            implementation(projects.shared.feature.homepage)
            implementation(projects.shared.feature.playerDetails)
            implementation(projects.shared.feature.playersData)
            implementation(projects.shared.feature.rolesDistribution)
            implementation(projects.shared.feature.rules)
